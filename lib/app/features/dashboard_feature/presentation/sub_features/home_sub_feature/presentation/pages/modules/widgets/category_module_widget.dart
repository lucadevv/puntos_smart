...
class CategoryModuleWidget extends StatefulWidget {
  ...
  @override
  State<CategoryModuleWidget> createState() => _CategoryModuleWidgetState();
}

class _CategoryModuleWidgetState extends State<CategoryModuleWidget> {
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: CustomOnTap(
                                onTap: () {
                                  context.push(
                                    "${NameRoutes.homeScreen}/${NameRoutes.moduleScreen}/${widget.idModule}/${NameRoutes.categorysScreen}/${item.category}",
