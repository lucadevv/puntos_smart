...
import 'package:puntos_smart_user/app/features/dashboard_feature/presentation/sub_features/home_sub_feature/presentation/pages/modules/pages/store_detail/presentation/slivers/sliver_appbar_widget.dart';
import 'package:puntos_smart_user/app/features/dashboard_feature/presentation/sub_features/home_sub_feature/presentation/pages/modules/pages/store_detail/presentation/slivers/sliver_categories.dart';
import 'package:puntos_smart_user/app/features/dashboard_feature/presentation/sub_features/home_sub_feature/presentation/pages/modules/pages/store_detail/presentation/slivers/sliver_desc_widget.dart';
...
import 'package:puntos_smart_user/app/features/dashboard_feature/presentation/sub_features/home_sub_feature/presentation/pages/modules/pages/store_detail/presentation/slivers/sliver_textspan_widget.dart';
import 'package:puntos_smart_user/app/features/dashboard_feature/presentation/sub_features/home_sub_feature/presentation/pages/modules/pages/store_detail/presentation/widgets/floatingb_widget.dart';

class StoreDetailScreen extends StatefulWidget {
  final int index;
  const StoreDetailScreen({super.key, required this.index});

  @override
  State<StoreDetailScreen> createState() => _StoreScreenState();
}

class _StoreScreenState extends State<StoreDetailScreen> {
        ...
        child: Scaffold(
          body: CustomScrollView(
            ...
            slivers: [
              ...
              SliverDescWidget(
                  categoryKeys: categoryKeys, textTheme: textTheme),
              SliverList.builder(
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            context.push(
                                              "${NameRoutes.homeScreen}/${NameRoutes.moduleScreen}/${NameRoutes.storesScreen}/${NameRoutes.storeDetailScreen}/$index/${NameRoutes.productDetailScreen}/$subIndex",
                                            ...
                                            children: [
                                              ...
                                              Align(
                                                ...
                                                child:
                                                  ...
                                                  onTap: () {
                                                    context.push(
                                                      '${NameRoutes.couponsScreen}/1/$subIndex',
                                                    );
                                                  },
                                                  heigh: 40,
                                                  width: 40,
