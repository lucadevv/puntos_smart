...
class SliverBannersModuleWidget extends StatefulWidget {
  const SliverBannersModuleWidget({
    super.key,
  });

  @override
  State<SliverBannersModuleWidget> createState() =>
      _SliverBannersModuleWidgetState();
}

class _SliverBannersModuleWidgetState extends State<SliverBannersModuleWidget> {
    ...
    return SliverToBoxAdapter(
      child: BlocBuilder<ModuleBloc, ModuleState>(
        builder: (context, state) {
          final bannerList = state.listGeoPromotiosns;
          switch (state.geoPromotionsStatus) {
            case GeoPromotionsStatus.loading:
              return SizedBox(
                height: 180,
                width: size.width,
            ...
            case GeoPromotionsStatus.success:
              return SizedBox(
                height: 180,
                width: size.width,
                child: CarouselSlider.builder(
