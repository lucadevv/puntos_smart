import '../../../../data/model/response/module/geo_promotions_response_model.dart';

class GeoPromotionsResponseEntity {
  ...
  GeoPromotionsResponseEntity copyWith({
  ...
  factory GeoPromotionsResponseEntity.fromJson(Map<String, dynamic> json) =>
      GeoPromotionsResponseEntity(
  ...
  factory GeoPromotionsResponseEntity.modelToEntity(
          {required GeoPromotionsResponseDbModel model}) =>
      GeoPromotionsResponseEntity(
  ...
  static List<GeoPromotionsResponseEntity> listModelToListEntity(
      {required List<GeoPromotionsResponseDbModel> listModel}) {
    return listModel
        .map((model) => GeoPromotionsResponseEntity.modelToEntity(model: model))
        .toList();
  }
}
